...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md rounded-0 navbar-light shadow " >
        <div class="container-fluid">
            <div class="brand">
                <a class="navbar-brand brand_logo" href="index.html"><img src="assets/images/logo.png" alt="" class="d-inline-block align-top " width="50 my-auto" height="40">Shopify</a>
            </div>
                    <div class="search_form my-auto justify-content-center mx-md-auto">
                        <form class=" d-flex  ">
                            <input class="form-control mr-2 search_input text-white  " id="selector" type="search" placeholder="Search" aria-label="Search">
                            <button class="btn border-0 search_submit " type="submit"><i class="fas fa-search"></i></button>
                        
                        </form>
                        <!-- <hr class="w-50 py-1 mx-auto text-white">
                        <div class="container-fluid">
                            <ul class="list-group">
                    ...
                    <ul class="navbar-nav mb-2 mb-md-0 ml-md-auto nav_item">
                        <li class="nav-item mr-md-3">
                            <a class="nav-link active"><i class="fas fa-sign-in-alt mr-1"></i>Login</a>
                        </li>
                        <li class="nav-item mr-md-5">
                            <a class="nav-link" href="cart.html">
                                <i class="fas fa-shopping-cart fa-xl">
                        ...
                        <button class="navbar-toggler d-none" type="button" data-toggle="collapse" data-target="#navbarText1" aria-controls="navbarText1" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="container">
        <div class="row  my-4 py-3 mx-auto">
            <div class="col-12 col-md-4 ml-auto card">
                <h2 class=" ml-3 pt-5">Address</h2>    
                <p class="lead ml-3">119,shree Ram Nagar Soc.,Dhakwada,Bilimora,Navsari Gujarat,India </p>
                <h2 class=" ml-3 pt-4 ">Email & Mobile Number</h2>    
                <p class="lead ml-3"> Rathodriteshrock@gmail.com <br>+91 8734051728 </p>
            </div>
            <div class="col-12 bg-white shadow rounded p-4 mr-auto  col-md-6 ">
                <div class="col-12 ">
                    <h3 class="display-5 pt-3">Contact Us</h3>
                    <p>If You face Any Problem Just Message Us We will fix as soon as possible</p>
                </div>
                <form class="row g-3 needs-validation" >
                    ...
                    <div class="col-12">
                    <button class="btn btn-danger px-4 btn-block" type="submit">Send A Message</button>
                    </div>
                </form>
            </div>
